...
public class Umrechnungen
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println(((5/60)*100)+(5%60));    //Ausdruck für das Umschreiben einer Uhr mit 5 Minuten
		System.out.println(((59/60)*100)+(59%60));  //Ausdruck für das Umschreiben einer Uhr mit 59 Minuten
		System.out.println(((60/60)*100)+(60%60));  //Ausdruck für das Umschreiben einer Uhr mit 60 Minuten
		System.out.println(((61/60)*100)+(61%60));  //Ausdruck für das Umschreiben einer Uhr mit 61 Minuten
